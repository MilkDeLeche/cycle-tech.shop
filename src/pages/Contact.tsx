...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/528684653206?text=${encodedMessage}`, '_blank');
          ...
          <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-noir-600">
                      <a href="https://wa.me/528684653206" className="hover:text-noir-900 flex items-center">
            ...
            <div className="mt-16">
              ...
              <div className="rounded-lg overflow-hidden shadow-lg h-[400px] relative">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6025.826848568792!2d-97.48654529999999!3d25.861177299999994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x866f951175fb1083%3A0xd6638f40f8a68210!2sCYCLE%20TECH%20BIKES!5e1!3m2!1sen!2sus!4v1750035273133!5m2!1sen!2sus" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                ...
                <a 
                  ...
                  className="absolute bottom-4 right-4 bg-white px-4 py-2 rounded-lg shadow-md text-noir-600 hover:text-noir-900 transition-colors flex items-center gap-2"
                >
              ...
              <div className="mt-4 text-center">
                ...
                <p className="text-noir-600">Treviño Zapata, 87430</p>
                <p className="text-noir-600">Heroica Matamoros, Tamps., México</p>
                <p className="text-noir-600 mt-2">Abierto de Lunes a Sábado: 10am-7pm</p>
              </div>
            </div>
          </div>
        </div>
